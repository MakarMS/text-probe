...
use TextProbe\Probes\UUID\UUIDv6Probe;
...
class UUIDv6ProbeTest extends TestCase
{
    public function testFindsSingleUUIDv6(): void
    {
        ...
        $this->assertEquals(ProbeType::UUID_V6, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleUUIDv6(): void
    {
        ...
        $this->assertEquals(ProbeType::UUID_V6, $results[1]->getProbeType());
    }
