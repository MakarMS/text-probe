...
use TextProbe\Probes\UUID\UUIDv2Probe;

class UUIDv2ProbeTest extends TestCase
{
    public function testFindsSingleUUIDv2(): void
    {
        ...
        $this->assertEquals('f47ac10b-58cc-21e4-8a5c-0002a5d5c51b', $results[0]->getResult());
        $this->assertEquals(9, $results[0]->getStart());
        $this->assertEquals(45, $results[0]->getEnd());
        $this->assertEquals(ProbeType::UUID_V2, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleUUIDv2(): void
    {
        $probe = new UUIDv2Probe();
        ...
        $this->assertEquals('f47ac10b-1234-21e4-aaaa-0002a5d5c51b', $results[1]->getResult());
        $this->assertEquals(53, $results[1]->getStart());
        $this->assertEquals(89, $results[1]->getEnd());
        $this->assertEquals(ProbeType::UUID_V2, $results[1]->getProbeType());
    }

    public function testMatchesUppercaseUUIDv2(): void
    {
        $probe = new UUIDv2Probe();
    ...
    public function testUUIDv2NextToPunctuation(): void
    {
        $probe = new UUIDv2Probe();
