...
use TextProbe\Probes\Finance\Reference\InvoiceNumberProbe;

/**
 * @internal
 */
class InvoiceNumberProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new InvoiceNumberProbe();
        ...
        $this->assertSame(ProbeType::INVOICE_NUMBER, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::INVOICE_NUMBER, $results[1]->getProbeType());
    }
