...
use TextProbe\Probes\Finance\Crypto\Transaction\CryptoTransactionIdProbe;

/**
 * @internal
 */
class CryptoTransactionIdProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new CryptoTransactionIdProbe();
        ...
        $this->assertSame(ProbeType::CRYPTO_TRANSACTION_ID, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::CRYPTO_TRANSACTION_ID, $results[1]->getProbeType());
    }
    ...
    public function testMatchesWithinSentence(): void
    {
        ...
        $text = 'Prefix AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA suffix';
        $results = $probe->probe($text);
    ...
    public function testFindsMultipleWithPunctuation(): void
    {
        ...
        $text = 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA, 0xcccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc';
        $results = $probe->probe($text);
