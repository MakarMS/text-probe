...
use TextProbe\Probes\Finance\Payment\PaypalTransactionIdProbeStrict;

/**
 * @internal
 */
class PaypalTransactionIdProbeStrictTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new PaypalTransactionIdProbeStrict();
        ...
        $this->assertSame(ProbeType::PAYPAL_TRANSACTION_ID_STRICT, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::PAYPAL_TRANSACTION_ID_STRICT, $results[1]->getProbeType());
    }
