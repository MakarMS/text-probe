...
use TextProbe\Probes\Finance\OgrnNumberProbe;

/**
 * @internal
 */
class OgrnNumberProbeTest extends TestCase
{
    public function testFindsValidOgrn(): void
    {
        $probe = new OgrnNumberProbe();
        ...
        $this->assertEquals(ProbeType::OGRN_NUMBER, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleOgrnNumbers(): void
    {
        ...
        $this->assertEquals(ProbeType::OGRN_NUMBER, $results[1]->getProbeType());
    }
