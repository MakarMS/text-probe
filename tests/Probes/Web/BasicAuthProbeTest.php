...
use TextProbe\Probes\Web\BasicAuthProbe;

/**
 * @internal
 */
class BasicAuthProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new BasicAuthProbe();
        ...
        $this->assertSame(ProbeType::BASIC_AUTH, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::BASIC_AUTH, $results[1]->getProbeType());
    }
