...
use TextProbe\Probes\Web\OAuthRefreshTokenJwtProbe;

/**
 * @internal
 */
class OAuthRefreshTokenJwtProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new OAuthRefreshTokenJwtProbe();
        ...
        $this->assertSame(ProbeType::OAUTH_REFRESH_TOKEN_JWT, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::OAUTH_REFRESH_TOKEN_JWT, $results[1]->getProbeType());
    }
