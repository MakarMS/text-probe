...
use TextProbe\Probes\Web\OAuthRefreshTokenOpaqueProbe;

/**
 * @internal
 */
class OAuthRefreshTokenOpaqueProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new OAuthRefreshTokenOpaqueProbe();
        ...
        $this->assertSame(ProbeType::OAUTH_REFRESH_TOKEN_OPAQUE, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::OAUTH_REFRESH_TOKEN_OPAQUE, $results[1]->getProbeType());
    }
