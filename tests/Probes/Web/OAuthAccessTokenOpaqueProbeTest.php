...
use TextProbe\Probes\Web\OAuthAccessTokenOpaqueProbe;

/**
 * @internal
 */
class OAuthAccessTokenOpaqueProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new OAuthAccessTokenOpaqueProbe();
        ...
        $this->assertSame(ProbeType::OAUTH_ACCESS_TOKEN_OPAQUE, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::OAUTH_ACCESS_TOKEN_OPAQUE, $results[1]->getProbeType());
    }
