...
use TextProbe\Probes\Web\OAuthAccessTokenProbe;

/**
 * @internal
 */
class OAuthAccessTokenProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new OAuthAccessTokenProbe();
        ...
        $this->assertSame(ProbeType::OAUTH_ACCESS_TOKEN, $results[0]->getProbeType());
    }
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $this->assertSame(ProbeType::OAUTH_ACCESS_TOKEN, $results[1]->getProbeType());
    }
