...
use TextProbe\Probes\Identity\CompanyRegistration\SeOrganisationsnummerProbe;

/**
 * @internal
 */
class SeOrganisationsnummerProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new SeOrganisationsnummerProbe();

        $expected = '556016-0680';
        $prefix = 'Value:
';
        ...
        $this->assertSame(ProbeType::SE_ORGANISATIONSNUMMER, $results[0]->getProbeType());
    }
...
';
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $expectedFirst = '556016-0680';
        $expectedSecond = '556123-4567';
        $text = 'First
' . $expectedFirst . '
then
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::SE_ORGANISATIONSNUMMER, $results[1]->getProbeType());
    }
