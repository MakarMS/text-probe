...
use TextProbe\Probes\Identity\CompanyRegistration\ItCodiceReaProbe;

/**
 * @internal
 */
class ItCodiceReaProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new ItCodiceReaProbe();
...
';
        ...
        $this->assertSame(ProbeType::IT_CODICE_REA, $results[0]->getProbeType());
    }
...
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::IT_CODICE_REA, $results[1]->getProbeType());
    }
