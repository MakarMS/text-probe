...
use TextProbe\Probes\Identity\TaxNumber\GbUtrProbe;

/**
 * @internal
 */
class GbUtrProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new GbUtrProbe();
...
';
        ...
        $this->assertSame(ProbeType::GB_UTR, $results[0]->getProbeType());
    }
...
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::GB_UTR, $results[1]->getProbeType());
    }
