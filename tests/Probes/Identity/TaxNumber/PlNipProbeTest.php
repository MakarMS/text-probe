...
use TextProbe\Probes\Identity\TaxNumber\PlNipProbe;

/**
 * @internal
 */
class PlNipProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new PlNipProbe();
...
';
        ...
        $this->assertSame(ProbeType::PL_NIP, $results[0]->getProbeType());
    }
...
';
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $expectedFirst = '1234563218';
        $expectedSecond = '8567346215';
        $text = 'First
' . $expectedFirst . '
then
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::PL_NIP, $results[1]->getProbeType());
    }
