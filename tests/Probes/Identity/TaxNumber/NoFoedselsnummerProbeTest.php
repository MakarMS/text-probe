...
use TextProbe\Probes\Identity\TaxNumber\NoFoedselsnummerProbe;

/**
 * @internal
 */
class NoFoedselsnummerProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new NoFoedselsnummerProbe();
...
';
        ...
        $this->assertSame(ProbeType::NO_FOEDSELSNUMMER, $results[0]->getProbeType());
    }
...
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::NO_FOEDSELSNUMMER, $results[1]->getProbeType());
    }
