...
use TextProbe\Probes\Identity\MedicalPolicy\PlPeselMedicalProbe;

/**
 * @internal
 */
class PlPeselMedicalProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new PlPeselMedicalProbe();
...
';
        ...
        $this->assertSame(ProbeType::PL_PESEL_MEDICAL, $results[0]->getProbeType());
    }
...
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::PL_PESEL_MEDICAL, $results[1]->getProbeType());
    }
