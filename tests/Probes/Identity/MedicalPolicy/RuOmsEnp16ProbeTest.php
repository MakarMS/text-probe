...
use TextProbe\Probes\Identity\MedicalPolicy\RuOmsEnp16Probe;

/**
 * @internal
 */
class RuOmsEnp16ProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new RuOmsEnp16Probe();
...
';
        ...
        $this->assertSame(ProbeType::RU_OMS_ENP16, $results[0]->getProbeType());
    }
...
';
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $expectedFirst = '1234567890123456';
        $expectedSecond = '0000000000000000';
        $text = 'First
' . $expectedFirst . '
then
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::RU_OMS_ENP16, $results[1]->getProbeType());
    }
