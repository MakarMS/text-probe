...
use TextProbe\Probes\Identity\MedicalPolicy\NoFoedselsnummerMedicalProbe;

/**
 * @internal
 */
class NoFoedselsnummerMedicalProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new NoFoedselsnummerMedicalProbe();

        $expected = '10000000081';
        $prefix = 'Value:
';
        ...
        $this->assertSame(ProbeType::NO_FOEDSELSNUMMER_MEDICAL, $results[0]->getProbeType());
    }
...
';
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $expectedFirst = '10000000081';
        $expectedSecond = '10000000162';
        $text = 'First
' . $expectedFirst . '
then
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::NO_FOEDSELSNUMMER_MEDICAL, $results[1]->getProbeType());
    }
