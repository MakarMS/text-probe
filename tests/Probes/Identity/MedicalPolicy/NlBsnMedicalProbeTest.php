...
use TextProbe\Probes\Identity\MedicalPolicy\NlBsnMedicalProbe;

/**
 * @internal
 */
class NlBsnMedicalProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new NlBsnMedicalProbe();
...
';
        ...
        $this->assertSame(ProbeType::NL_BSN_MEDICAL, $results[0]->getProbeType());
    }
...
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::NL_BSN_MEDICAL, $results[1]->getProbeType());
    }
