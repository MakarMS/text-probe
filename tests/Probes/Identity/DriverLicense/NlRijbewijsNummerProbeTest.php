...
use TextProbe\Probes\Identity\DriverLicense\NlRijbewijsNummerProbe;

/**
 * @internal
 */
class NlRijbewijsNummerProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new NlRijbewijsNummerProbe();
...
';
        ...
        $this->assertSame(ProbeType::NL_RIJBEWIJS_NUMMER, $results[0]->getProbeType());
    }
...
';
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $expectedFirst = '1234567890';
        $expectedSecond = '0987654321';
        $text = 'First
' . $expectedFirst . '
then
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::NL_RIJBEWIJS_NUMMER, $results[1]->getProbeType());
    }
