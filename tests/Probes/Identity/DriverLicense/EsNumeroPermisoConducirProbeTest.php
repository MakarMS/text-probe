...
use TextProbe\Probes\Identity\DriverLicense\EsNumeroPermisoConducirProbe;

/**
 * @internal
 */
class EsNumeroPermisoConducirProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new EsNumeroPermisoConducirProbe();
...
';
        ...
        $this->assertSame(ProbeType::ES_NUMERO_PERMISO_CONDUCIR, $results[0]->getProbeType());
    }
...
';
    ...
    public function testFindsMultipleMatches(): void
    {
        ...
        $expectedFirst = '12345678A';
        $expectedSecond = '87654321Z';
        $text = 'First
' . $expectedFirst . '
then
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::ES_NUMERO_PERMISO_CONDUCIR, $results[1]->getProbeType());
    }
