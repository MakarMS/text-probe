...
use TextProbe\Probes\Identity\DriverLicense\ChFuehrerausweisNummerProbe;

/**
 * @internal
 */
class ChFuehrerausweisNummerProbeTest extends TestCase
{
    public function testFindsSingleMatch(): void
    {
        $probe = new ChFuehrerausweisNummerProbe();
...
';
        ...
        $this->assertSame(ProbeType::CH_FUEHRERAUSWEIS_NUMMER, $results[0]->getProbeType());
    }
...
' . $expectedSecond;
        ...
        $this->assertSame(ProbeType::CH_FUEHRERAUSWEIS_NUMMER, $results[1]->getProbeType());
    }
