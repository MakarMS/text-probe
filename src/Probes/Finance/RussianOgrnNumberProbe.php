...
use TextProbe\Validator\Finance\Company\RussianOgrnNumberValidator;
 ...
 * {@see RussianOgrnNumberValidator} to reduce false positives in numeric text.
 */
class RussianOgrnNumberProbe extends Probe implements IProbe
{
    /**
     * @param IValidator|null $validator Optional custom validator. If omitted,
     *                                   {@see RussianOgrnNumberValidator} is used.
     */
    public function __construct(?IValidator $validator = null)
    {
        parent::__construct($validator ?? new RussianOgrnNumberValidator());
    }
    ...
    {
        return ProbeType::RUSSIAN_OGRN_NUMBER;
    }
}
