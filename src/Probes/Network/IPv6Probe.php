 ...
 *
 * This probe supports full and compressed IPv6 notation, IPv4-mapped IPv6
 * addresses and optional zone identifiers (e.g. "%eth0"), using lookarounds
 * to avoid matching substrings inside longer tokens.
 */
